...
#[cfg(windows)]
unsafe extern "system" fn filter_windows_callback(hwnd: HWND, _l_param: LPARAM) -> i32 {
	match check_valid_window(hwnd) {
		Some(window) => match &mut ACTIVE_WINDOWS {
